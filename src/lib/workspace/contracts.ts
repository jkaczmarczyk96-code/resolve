...
export const detailSchema = z.object({ problem: problemSummarySchema, job: webJobSchema.nullable(), snapshot: fullSnapshotSchema.nullable(), humanRequest: humanRequestSchema.nullable() });
