...
export function LiveProblemList({ overview = false }: { overview?: boolean }) {
  ...
  return <div className="space-y-7">
    ...
    {overview && <div className="flex flex-wrap gap-3 rounded-xl border bg-card p-5 text-sm"><p className="flex-1 text-muted-foreground">Give Avenli a problem. Follow its research, review the recommendation, and inspect the proposed tasks.</p><Link className="font-medium text-primary hover:underline" href="/dashboard?demo=1">Explore demo</Link></div>}
