...
export function NewLiveProblem() {
  ...
  return <div className="space-y-7"><PageHeading eyebrow="New problem" title="What do you need to solve?" description="Tell Avenli what you need to achieve. Be as open-ended as you like." /><div className="grid items-start gap-5 xl:grid-cols-[minmax(0,1fr)_320px]"><Panel title="Your starting point" description="Describe the outcome, the situation and what matters most. Avenli will structure the work."><form className="space-y-5" onSubmit={async (event) => {
