...
export function DemoDashboard() {
  ...
  return <div className="space-y-8">
    <PageHeading demo eyebrow="Your overview" title={account.displayName ? `Welcome, ${account.displayName}` : "Welcome to Avenli"} description="A little clarity on what matters, what’s moving, and what needs you next." action />
