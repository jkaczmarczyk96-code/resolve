...
export default function PrivacyPage() {
  return (
    <LegalPage title="Privacy Policy" intro="This policy explains what Avenli collects, why it is used, and the choices available to you.">
      ...
      <section><h2>Connected Google services</h2><p>If you choose to connect Google Calendar and Gmail, Avenli reads upcoming calendar event details and Gmail search results consisting of message metadata and short snippets. Avenli uses this data only to show the context you requested inside your account. It does not send email, change calendar events, sell Google user data or use it for advertising. Access tokens are encrypted, access is read-only, and you can disconnect Google from Settings at any time.</p></section>
